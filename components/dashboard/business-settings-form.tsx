...
export function BusinessSettingsForm({ business }: BusinessSettingsFormProps) {
  ...
  return (
    <form action={updateBusinessSettingsAction} className="space-y-5">
      ...
      <details className="overflow-hidden rounded-[1.5rem] border border-[var(--color-border)] bg-[var(--color-surface)]">
          ...
          <div className="space-y-3">
            {DAY_LABELS.map((label, day) => {
              ...
              return (
                <div
                  key={label}
                  className="grid gap-3 rounded-[1.25rem] border border-[var(--color-border)] bg-white p-4 md:grid-cols-[140px_minmax(0,1fr)_minmax(0,1fr)_120px]"
                >
                  ...
                  <label className="flex items-center justify-between rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-3 text-sm text-[var(--color-foreground)]">
                    <span>Cerrado</span>
                    <input
                      type="checkbox"
